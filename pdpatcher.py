...
if __name__ == "__main__":
	...
	with open(join(args.out_dir, "pdfw"), "wb") as pdfw:
		if not args.no_patch:
			...
			idx = decrypted.find(
				b"\x38\xb5\x04\x46\x0d\x46\x01\x46\x0c\x48\x32\xf0\x43\xfa\x50\xb1\x20\x46\x32\xf0\x70\xfa\x0a\x28\x0e\xd9\x0a\x38\x08\x49\x20\x44\x32\xf0\x38\xfa\x40\xb9\x05\x22\x06\x49\x28\x46\x32\xf0\xa1\xfa\xb0\xfa\x80\xf0\x40\x09\x38\xbd\x00\x20\xfc\xe7"
			)
